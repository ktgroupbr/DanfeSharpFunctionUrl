...
namespace DanfeSharp.Modelo
{
    public static class DanfeViewModelCreator
    {
        ...
        public static DanfeViewModel CreateFromXml(ProcNFe procNfe)
        {
            ...
            model.Emitente.NomeFantasia = model.Emitente.RazaoSocial;   //Bloco Emitente
            ...
            if (infAdic != null)
            {
                ...
                var obsCont = infAdic.obsCont;
                if (obsCont != null)
                {
                    if (!String.IsNullOrEmpty(model.InformacoesComplementares))
                    {
                        model.InformacoesComplementares += Environment.NewLine;
                    }

                    foreach (var cont in obsCont)
                    {
                        model.InformacoesComplementares += cont.xTexto;
                    }
                ...
                var obsFisco = infAdic.obsFisco;
                if (obsFisco != null)
                {
                    if (!String.IsNullOrEmpty(model.InformacoesAdicionaisFisco))
                    {
                        model.InformacoesAdicionaisFisco += Environment.NewLine;
                    }

                    foreach (var fisco in obsFisco)
                    {
                        model.InformacoesAdicionaisFisco += fisco.xTexto;
                    }
