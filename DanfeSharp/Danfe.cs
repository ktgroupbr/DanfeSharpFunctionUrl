...
namespace DanfeSharp
{
    public class Danfe : IDisposable
    {
        ...
        private void AdicionarMetadata()
        {
            ...
            info.Creator = "Taxfy"; //String.Format("{0} {1} - {2}", "DanfeSharp", System.Reflection.Assembly.GetExecutingAssembly().GetName().Version, "https://github.com/SilverCard/DanfeSharp");
